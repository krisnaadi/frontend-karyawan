<template>
  ...
  >
    ...
    <div class="flex items-center justify-between px-8 py-5">
      <div class="flex items-center mr-5">
        ...
        <div class="mr-2">
          ...
          >
          <span
            class="text-secondary-dark dark:text-stone-500 font-medium block text-[0.85rem]"
            >SEO Manager</span
          >
        </div>
      </div>
    ...
    <div class="relative pl-3 my-5 h-screen overflow-y-scroll">
      <div class="flex flex-col w-full font-medium">
        ...
        <div class="block pt-5 pb-[.15rem]">
          <div class="px-4 py-[.65rem]">
            <span
              class="font-semibold text-[0.95rem] uppercase dark:text-neutral-500/80 text-secondary-dark"
              >Logout</span
            >
          </div>
        </div>
